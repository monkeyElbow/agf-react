...
const RETIREMENT_ADAPTERS = Object.freeze([
  ...
  },
  {
    ...
    status: 'active',
    paths: Object.freeze(['/services/retirement/403b']),
    helpers: Object.freeze(['migrateRetirement403bLoanDetailsState']),
    sourceFiles: Object.freeze([SOURCE_FILES.store, SOURCE_FILES.migrations]),
    sourceSymbols: Object.freeze(['migrateRetirement403bLoanDetailsState']),
    detect: () => [],
    retireWhen: () => true,
    retireWhenDescription: 'Retired after the 403(b) loan-details block uses the one-card preset in active and baseline snapshots; the pre-migration HTML remains only in the versioned recovery backup.',
  },
  {
    id: 'retirement-rollover-process-card-grid',
    category: 'content-migration',
    status: 'active',
    paths: Object.freeze(['/services/retirement/rollovers']),
    helpers: Object.freeze(['migrateRetirementRolloverProcessState']),
    sourceFiles: Object.freeze([SOURCE_FILES.store, SOURCE_FILES.migrations]),
    sourceSymbols: Object.freeze(['migrateRetirementRolloverProcessState']),
    detect: () => [],
    retireWhen: () => true,
    retireWhenDescription: 'Retired after the rollover process uses the shared numbered step-card preset in active and baseline snapshots; the pre-migration HTML remains only in the versioned recovery backup.',
  },
  {
    id: 'retirement-individual-enrollment-step-card-presentation',
    category: 'presentation-migration',
    status: 'active',
    paths: Object.freeze(['/services/retirement/403b/403b-individual-enrollment']),
    helpers: Object.freeze(['migrateRetirementIndividualEnrollmentStepCardPresentationState']),
    sourceFiles: Object.freeze([SOURCE_FILES.store, SOURCE_FILES.migrations]),
    sourceSymbols: Object.freeze(['migrateRetirementIndividualEnrollmentStepCardPresentationState']),
    detect: () => [],
    retireWhen: () => true,
    retireWhenDescription: 'Retired after individual-enrollment step cards use separate 01/02/03 markers, authored titles, and shared typography/color controls in active and baseline snapshots.',
  },
  {
