...
export const CONTENT_ADMIN_MIGRATION_ADAPTERS = Object.freeze([
  ...
  },
  {
    ...
    affectedLayers: AFFECTED_LAYERS,
    retireWhen: 'Retired after the 403(b) loan-details block uses the one-card preset in active, base, revision, backup, and seed snapshots, with the original HTML retained for recovery.',
  },
  {
    ...
    affectedLayers: AFFECTED_LAYERS,
    retireWhen: 'Retired after the rollover process uses the shared numbered step-card preset in active, base, revision, backup, and seed snapshots, with the original page-content HTML retained for recovery.',
  },
  {
    ...
    affectedLayers: AFFECTED_LAYERS,
    retireWhen: 'Retired after individual-enrollment step cards use separate 01/02/03 markers, authored titles, and shared typography/color controls in active, base, revision, backup, and seed snapshots.',
  },
  {
    id: 'retirement-individual-enrollment-mail-fax-step',
    category: 'content-migration',
    paths: Object.freeze(['/services/retirement/403b/403b-individual-enrollment']),
    helpers: Object.freeze(['migrateRetirementIndividualEnrollmentMailFaxStepState']),
    affectedLayers: AFFECTED_LAYERS,
    retireWhen: 'Retired after the Mail/Fax content is represented by numbered Card Grid step 04 in active, base, revision, backup, and seed snapshots, with the original return_forms block retained in the card recovery field.',
  },
  {
