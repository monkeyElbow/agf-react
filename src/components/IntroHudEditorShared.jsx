...
export default function IntroHudEditorPanel({
  ...
  return (
    <div className="admin-intro-hud-editor">
      <div className="admin-intro-hud-main-stack">
        <section className="admin-front-hud-card admin-intro-hud-card">
          <div className="admin-front-hud-card-head">
            <h4>Heading</h4>
            <p>Title and emphasis</p>
          </div>
          ...
          <div className="admin-front-hud-field-group">
            ...
            <p className="admin-front-hud-note">Optional line beneath the heading.</p>
            <ColorPalette
              variant="hud"
      ...
      <section className="admin-front-hud-card admin-intro-hud-card admin-intro-hud-card--body">
        <div className="admin-front-hud-card-head">
          <h4>Body</h4>
          <p>Copy and body color</p>
        </div>
        <div className="admin-front-hud-intro-body-group">
          ...
          <p className="admin-front-hud-note">Click body copy on page to jump here.</p>
          <div className="admin-front-hud-intro-body-editor">
            {bodyMiniEditorEnabled ? (
        ...
        <p className="admin-front-hud-note">Base tone sets the default intro copy color. The HTML editor swatches add inline emphasis inside the body content.</p>
      </section>
      {actionsSlot}
    </div>
  );
