...
describe('ServicesPage breakdown directory', () => {
  it('renders the requested breakdown intro, rows, and revised service copy', () => {
    ...
    expect(screen.getByRole('heading', { level: 2, name: 'Explore each area of our complete strategy.' })).toBeTruthy();
  ...
  it('renders the requested service links and removes the old loan inquiry link and search card', () => {
    ...
    const expectedLinks = [
      ...
      ['AGFinancial 403(b)', '/services/retirement/403b'],
      ['IRAs', '/services/retirement/iras'],
      ['409A', '/services/retirement/409a'],
      ['Charitable Gift Annuities', '/services/legacy-giving/charitable-gift-annuities'],
      ['Charitable Trusts', '/services/legacy-giving/charitable-trusts'],
      ['Donor Advised Funds / Generosity Fund', '/services/legacy-giving/generosity-fund'],
      ['Endowments', '/services/legacy-giving/endowments'],
      ['Wills & Estate Services', '/services/legacy-giving'],
