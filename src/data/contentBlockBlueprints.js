...
const RAW_CONTENT_BLOCK_BLUEPRINTS_BY_PATH = {
  ...
  '/about-us': [
    ...
    },
    {
      ...
      settings: {
        ...
        field4Enabled: true,
        field4Type: 'textarea',
        field4Label: DEFAULT_MESSAGE_PLACEHOLDER,
        field4Placeholder: '',
        field4Options: '',
  ...
  '/calculators': [
    ...
    {
      id: 'ministers_housing_quick_check',
      name: "Ministers' Housing Allowance Quick Check",
      kind: PAGE_CONTENT_IDENTITY.kind,
      mode: 'dynamic',
      settings: {
        title: "Ministers' Housing Allowance Quick Check",
        ...
        titleHighlightsJson: '',
        subtitle: '',
        body: 'Compare your annual housing expenses to Fair Rental Value (FRV) and estimate the maximum amount you may be able to claim.',
        html: '',
  ...
  '/services/planned-giving/charitable-trusts': [
    ...
    },
    {
      ...
      settings: {
        ...
        field5Enabled: true,
        field5Type: 'select',
        field5Label: 'Trust product of interest*',
        field5Placeholder: 'Select one',
        field5Options: 'charitable-remainder-trust|Charitable Remainder Trust\ncharitable-lead-trust|Charitable Lead Trust',
        field5Required: true,
        fieldsJson: JSON.stringify([
          { id: 'firstName', label: 'First Name*', type: 'text', required: true },
          { id: 'lastName', label: 'Last Name*', type: 'text', required: true },
  ...
  '/services/retirement/403b': [
    ...
    }),
    {
      ...
      settings: {
        ...
        button2Tone: 'super-grey',
        anchorId: '',
        sectionClassName: 'retirement-403b-native-benefits-callout',
      },
      editableFields: sharedDynamicBillboardEditableFields,
    },
    createDynamicCardGridBlueprint({
  ...
  '/services/insurance/life-insurance-quote': [
    ...
    }),
    {
      ...
      settings: {
        ...
        html: '',
        sectionClassName: 'life-quote-native-bridge',
        copyWrap: false,
        fullBleed: false,
        paddingTopRem: 2.4,
        paddingBottomRem: 2.4,
  ...
  '/services/insurance/ministers-group-life-plan': [
    ...
    },
    {
      ...
      settings: {
        ...
        field4Placeholder: 'How can we help?',
      },
      editableFields: ctaFormEditableFields,
    },
  ],
