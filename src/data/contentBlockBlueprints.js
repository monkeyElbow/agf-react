  ...
  '/services/planned-giving/endowments': [
    ...
    }),
    {
      ...
      settings: {
        ...
        subtitle: '',
        body: '',
        html: '<div class="endowments-assets-copy"><h2 class="endowments-assets-title">Assets you may give</h2><p class="endowments-assets-funding">Minimum funding requirements are <strong>$10,000</strong> for cash or securities, and <strong>$100,000</strong> for real estate.</p></div><ul class="endowments-asset-badges"><li>Cash</li><li>Real estate</li><li>Art</li><li>Securities (restricted and marketable)</li><li>Antiques</li><li>Business interests</li></ul>',
        widget: '',
        fullBleed: false,
        spaceBeforeRem: 0,
        spaceAfterRem: 0,
