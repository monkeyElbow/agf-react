...
function seedBlueprintCardGridCardFields(cardNumber, {
  ...
  return {
    ...
    [`card${cardNumber}IconKey`]: iconKey,
    [`card${cardNumber}IconTone`]: iconTone,
    [`card${cardNumber}Body`]: body,
    [`card${cardNumber}CopyLabel`]: copyLabel,
    [`card${cardNumber}CopyText`]: copyText,
    ...
    ...(buttonStyle ? { [`card${cardNumber}ButtonStyle`]: buttonStyle } : {}),
    ...(buttonTone ? { [`card${cardNumber}ButtonTone`]: buttonTone } : {}),
    ...
    ...(button2Style ? { [`card${cardNumber}Button2Style`]: button2Style } : {}),
    ...(button2Tone ? { [`card${cardNumber}Button2Tone`]: button2Tone } : {}),
...
function createConsultantRequestFormBlueprint({ step2MinistryFieldId }) {
  return {
    id: 'request_form',
    name: 'Consultant Contact Request Form',
    kind: 'request_form',
    mode: 'dynamic',
    hidden: false,
    settings: {
      ...
      step2FieldsJson: JSON.stringify([
        { id: step2MinistryFieldId, label: 'Church or Ministry*', type: 'text', required: true },
        { id: 'city', label: 'City*', type: 'text', required: true },
        { id: 'state', label: 'State*', type: 'select', required: true, placeholder: 'Choose one', options: requestFormStateOptions },
        { id: 'message', label: 'Message', type: 'textarea', placeholder: DEFAULT_MESSAGE_PLACEHOLDER, rows: 4 },
      ]),
      step3FieldsJson: '[]',
      step4FieldsJson: '[]',
      step5FieldsJson: '[]',
...
function createCareersPageBlockBlueprints() {
  return [
    {
      id: 'hero',
      name: 'Careers Hero',
      ...
      settings: {
        ...
        lineHeight: 0.92,
        lineGap: 0.04,
        line1Text: 'Be part of',
        line1ClassName: 'careers-hero-line is-mango',
        line1HighlightsJson: '',
        line2Text: 'something',
        line2ClassName: 'careers-hero-line is-mango',
        line2HighlightsJson: '',
        line3Text: 'bigger.',
        line3ClassName: 'careers-hero-line careers-hero-line--major is-mango',
        line3HighlightsJson: JSON.stringify([{ text: 'bigger', className: 'is-mango' }]),
      },
    ...
    },
    {
      ...
      settings: {
        ...
        extraLineTone: 'atlantean',
        extraLineClassName: 'careers-native-top-intro-emphasis fade-up fade-up-force-observe fade-up-repeat-observe billboard-scroll-reveal-scale-up',
        bgTone: 'white',
        textTone: 'dark',
        justify: 'center',
        lineSpacing: 1.04,
        sectionClassName: 'careers-native-top-intro',
    ...
    createDynamicCardGridBlueprint({
      ...
      settings: {
        ...
        fullBleed: true,
        cardStyle: 'card3',
        sectionClassName: 'careers-native-benefits',
        ...seedBlueprintCardGridCardFields(1, { title: 'Paid Time Off (PTO)', body: 'Service-based, and earns up to 120 hours per year.', cardClassName: 'card3' }),
        ...seedBlueprintCardGridCardFields(2, { title: 'Mortgage program', body: 'Special loan financing rates for full-time employees.', cardClassName: 'card3' }),
        ...seedBlueprintCardGridCardFields(3, { title: 'Bonuses', body: 'Potential annual bonus plan.', cardClassName: 'card3' }),
        ...seedBlueprintCardGridCardFields(4, { title: 'Insurance', body: 'Medical, dental, vision, supplemental, and more.', cardClassName: 'card3' }),
        ...seedBlueprintCardGridCardFields(5, { title: 'Holidays', body: '14 paid holidays per year.', cardClassName: 'card3' }),
        ...seedBlueprintCardGridCardFields(6, { title: 'Retirement', body: '403(b) plan with options, and 9% company contribution (when eligible).', cardClassName: 'card3' }),
        ...seedBlueprintCardGridCardFields(7, { title: 'Students', body: 'Student loan and tuition assistance programs available.', cardClassName: 'card3' }),
        ...seedBlueprintCardGridCardFields(8, { title: 'Perks', body: 'Onsite fitness center, complimentary coffee, espresso, and tea, and more…', cardClassName: 'card3' }),
      },
    }),
    createDynamicBillboardBlueprint({
      id: 'ready',
      name: 'Careers Ready Prompt',
      settings: {
        ...
        justify: 'center',
        bodyJustify: 'center',
        sectionClassName: 'careers-native-ready',
    ...
    createDynamicBillboardBlueprint({
      id: 'matters',
      name: 'Careers Mission Prompt',
      settings: {
        title: 'Your work matters.',
        titleHighlightsJson: JSON.stringify([{ text: 'matters', className: 'is-atlantean' }]),
        bodyHtml: '',
...
const RAW_CONTENT_BLOCK_BLUEPRINTS_BY_PATH = {
  ...
  '/about-us': [
    ...
    }),
    {
      ...
      kind: 'billboard',
      mode: 'dynamic',
      settings: buildBillboardPresetSettings('default', {
        title: 'Ministry allies.',
        titleClassName: '',
        titleHighlightsJson: '',
        subtitle: '',
        bodyHtml: '<p>We\'re <mark class="is-atlantean">serving</mark> you, <mark class="is-mango">alongside</mark> you.</p>',
        body: '',
        bgTone: 'blue',
        textTone: 'white',
        justify: 'center',
  ...
  '/about-us/careers': createCareersPageBlockBlueprints(),
  '/forms': [],
  '/prospectus': [],
  '/search': [],
  '/sitemap': [],
  ...
  '/services/retirement/rollovers': [
    ...
    createDynamicCardGridBlueprint({
      ...
      settings: {
        ...
        ...seedBlueprintCardGridCardFields(1, {
          title: '1',
          body: 'Download and complete the Rollover/Transfer form below.',
          buttonLabel: 'Rollover/Transfer Form',
          buttonDocumentId: 'document-retirement-rollover-transfer-form',
        }),
        ...seedBlueprintCardGridCardFields(2, {
          title: '2',
          body: 'Return the completed form, along with the most recent statement(s) from the other account(s) to the address below.<br><br><strong>AGFinancial</strong><br>PO Box 2515<br>Springfield MO 65801',
          copyLabel: 'Copy mailing address',
          copyText: 'AGFinancial\nPO Box 2515\nSpringfield MO 65801',
        }),
        ...seedBlueprintCardGridCardFields(3, {
          title: '3',
          body: 'A confirmation letter will be sent to you when your rollover or transfer is complete.',
        }),
      },
    }),
    {
  ...
  '/services/planned-giving/charitable-gift-annuities': [
    ...
    }),
    {
      ...
      settings: {
        ...
        subtitle: '',
        body: '',
        html: '<p>Also available for <a href="/services/planned-giving/charitable-trusts#crt">Charitable Remainder Unitrust (CRUT)</a> or <a href="/services/planned-giving/charitable-trusts#crt">Charitable Remainder Annuity Trust (CRAT)</a>.</p>',
        widget: '',
        fullBleed: false,
        spaceBeforeRem: 0,
        spaceAfterRem: 0,
  ...
  '/services/planned-giving/charitable-trusts': [
    ...
    createDynamicCardGridBlueprint({
      ...
      settings: {
        ...
        titleClassName: '',
        titleHighlightsJson: '[{"text":"CRTs and CLTs","className":"is-atlantean"}]',
        bodyHtml: '',
        body: '',
        bgTone: 'white',
        contentWidth: 'content',
        ...
        ...seedBlueprintCardGridCardFields(1, {
          ...
          buttonHref: '#charitable-trusts-form',
          buttonStyle: 'blue',
          buttonTone: 'atlantean',
        }),
      },
    }),
    {
      ...
      settings: {
        ...
        titleHighlightsJson: '',
        subtitle: '',
        bodyHtml: '<p>You contribute cash, stocks, real estate, or other assets to AG Foundation to establish the trust. The trust pays you (and your spouse, if married) income for life. You can also designate others, like children, to receive payments for up to 20 years. When the trust ends, the remaining assets go to the ministry you’ve selected.</p>',
        body: '',
        bgTone: 'blue',
        textTone: 'white',
        justify: 'center',
    ...
    {
      id: 'request_form',
      name: 'Charitable Trusts Request Form',
      kind: 'request_form',
      mode: 'dynamic',
      settings: {
        title: 'Income and impact.',
        titleClassName: '',
        titleHighlightsJson: '[{"text":"and","className":"is-white"},{"text":"impact","className":"is-mango"}]',
  ...
  '/services/retirement/403b': [
    ...
    },
    {
      ...
      settings: {
        ...
        card1Title: '2026',
        card1Color: 'atlantean',
        card1Bullets: 'Under age 50 deferral limit (pre-tax and Roth after-tax): The lesser of $24,500 or includible compensation.\nAge 50 and up deferral limit*: The lesser of $32,500 or includible compensation.\nAge 60-63 deferral limit**: The lesser of $35,750 or includible compensation.\nOverall limit under age 50***: $72,000\nOverall limit age 50 and up†: $80,000\nOverall limit age 60-63**: $83,250',
        card2Title: '2025',
        card2Color: 'mango',
        card2Bullets: 'Under age 50 deferral limit (pre-tax and Roth after-tax): The lesser of $23,500 or includible compensation.\nAge 50 and up deferral limit*: The lesser of $31,000 or includible compensation.\nAge 60-63 deferral limit**: The lesser of $34,750 or includible compensation.\nOverall limit under age 50***: $70,000\nOverall limit age 50 and up†: $77,500\nOverall limit age 60-63**: $81,250',
        fineprint: [
    ...
    createDynamicCardGridBlueprint({
      ...
      settings: {
        ...
        ...seedBlueprintCardGridCardFields(1, {
          ...
          cardClassName: 'retirement-ira-type-card retirement-ira-type-card--traditional',
        }),
        ...seedBlueprintCardGridCardFields(2, {
          title: 'Roth IRA',
          ...
          cardClassName: 'retirement-ira-type-card retirement-ira-type-card--roth',
        }),
        ...seedBlueprintActionFields({
          labelField: 'buttonLabel',
          hrefField: 'buttonUrl',
  ...
  '/services/retirement/retirement-consultants': [
    createConsultantPageHeaderBlueprint('Retirement Consultants'),
    createConsultantRequestFormBlueprint({ step2MinistryFieldId: 'churchOrMinistry' }),
    createDynamicCardGridBlueprint({
    ...
    createDynamicCardGridBlueprint({
      ...
      settings: {
        ...
        ...seedBlueprintCardGridCardFields(4, {
          ...
          body: '<p>AGFinancial<br>PO Box 2515<br>Springfield, MO 65801</p><p><strong>FAX:</strong> 417.520.0406</p>',
          copyLabel: 'Copy mailing address',
          copyText: 'AGFinancial\nPO Box 2515\nSpringfield, MO 65801',
        }),
      },
  ...
  '/services': [
    ...
    },
    {
      ...
      settings: buildBillboardPresetSettings('default', {
        ...
        titleClassName: '',
        titleHighlightsJson: JSON.stringify([{ text: 'matters', className: 'is-white' }]),
        subtitle: '',
  ...
  '/services/loans': [
    ...
    createDynamicCardGridBlueprint({
      ...
      settings: {
        ...
        ...seedBlueprintCardGridCardFields(3, {
          title: 'Construction',
          body: 'New construction or renovation financing, featuring interest-only payments during the project. After construction, a guaranteed, no-cost conversion to permanent financing.',
        }),
        ...seedBlueprintCardGridCardFields(4, {
          title: 'Facelift',
  ...
  '/services/loans/loan-consultants': [
    createConsultantPageHeaderBlueprint('Loan Consultants'),
    createConsultantRequestFormBlueprint({ step2MinistryFieldId: 'ministry' }),
    createDynamicCardGridBlueprint({
      id: 'consultant_directory',
      name: 'Consultant Directory',
      presetId: 'default',
    ...
    },
    {
      ...
      settings: {
        ...
        ...seedBlueprintCardGridCardFields(1, {
          ...
          body: 'A Donor Advised Fund lets you contribute assets, receive an immediate tax deduction, and recommend grants to the ministries and causes you care about. It’s a tax-smart, flexible way to give on your own timeline.',
          buttonLabel: '',
          buttonHref: '',
          button2Label: 'Learn more',
          button2Href: '/services/planned-giving/donor-advised-fund',
        }),
        ...
        card6Button2Tone: 'super-grey',
        ...seedBlueprintCardGridCardFields(7, {
          title: 'Wills & Estates',
          body: 'Simple and straightforward, a will ensures a distribution end-of-life plan for your assets. This service is provided free of charge when you designate a 10% gift to an Assemblies of God ministry.',
          buttonLabel: 'Download packet',
          buttonDocumentId: 'form-planned-giving-will-planning-document',
          button2Label: 'Online form*',
          button2Href: 'https://sft.agfinancial.org/documents/Send.do',
          button2OpenInNewWindow: false,
        }),
        ...
        ...seedBlueprintCardGridCardFields(8, {
          ...
          body: 'Your IRA can do more than fund your retirement. If you’re 70½ or older, a Qualified Charitable Distribution (QCD) lets you transfer up to $110,000 per year directly to your church or an eligible ministry tax-free, and straight from the source.',
          buttonLabel: 'Learn more',
          buttonHref: '/services/planned-giving/qualified-charitable-distribution',
        }),
  ...
  '/services/planned-giving/qualified-charitable-distribution': [
    {
      ...
      settings: {
        ...
        line1ClassName: 'line1',
        line1HighlightsJson: '[{"text":"Charitable","className":"is-atlantean"}]',
        line2Text: 'Distribution',
        line2ClassName: 'line2',
        line2HighlightsJson: '[{"text":"Distribution","className":"is-mango"}]',
        line3Text: '',
        line3ClassName: '',
        line3HighlightsJson: '',
      },
  ...
  '/services/planned-giving/endowments': [
    {
      ...
      settings: {
        ...
        button1LinkJson: JSON.stringify({ kind: 'anchor', href: '#endowment-request-form', openInNewWindow: false }),
        button1Style: 'blue',
        button1Tone: 'atlantean',
      },
      editableFields: sharedDynamicHeroEditableFields,
    },
    {
      ...
      settings: {
        ...
        headingClassName: '',
        headingHighlightsJson: '',
        bodyHtml: '<p>Your endowment is a gift that gives forever. The annual earnings from your carefully-invested gift support your chosen ministry or cause. Meanwhile, your original gift stays protected and continues to grow.</p><p><strong>This generosity never runs out.</strong></p>',
        body: '',
        justify: 'center',
        lineSpacing: 1.04,
        extraLine: '',
    ...
    createDynamicCardGridBlueprint({
      ...
      settings: {
        ...
        ...seedBlueprintCardGridCardFields(1, {
          ...
          fineprint: 'Minimum funding requirements are $10,000 for cash or securities, and $100,000 for real estate.',
        }),
      },
    }),
    {
  ...
  '/services/planned-giving/donor-advised-fund': [
    {
      ...
      settings: {
        ...
        button1Url: '#traditional-daf-form',
        button1PageRef: '',
        button1Style: 'outline',
        button1Tone: 'super-grey',
        button2Label: 'Open a Generosity Fund®',
        button2Url: 'https://secure.agfinancial.org/generosityfund/signup',
        button2PageRef: '',
        button2Style: 'blue',
    ...
    createPlannedGivingHowItWorksColumnsBlueprint({
      ...
      buttonHref: '#traditional-daf-form',
      buttonStyle: 'outline',
      ...
      steps: [
        {
          iconKey: 'daf-step-1',
          iconTone: 'atlantean',
          body: 'Open a DAF, and fund it with cash or appreciated assets. You may receive immediate tax benefits.',
        },
        {
          iconKey: 'daf-step-2',
          iconTone: 'atlantean',
        ...
        },
        {
          iconKey: 'daf-step-3',
          iconTone: 'atlantean',
          body: 'Advise us where to provide grants to continue giving when and to whom you want. You may even give anonymously.',
        },
      ],
    }),
    {
      id: 'generosity_fund_online',
      name: 'Generosity Fund Online CTA',
      kind: PAGE_CONTENT_IDENTITY.kind,
      mode: 'dynamic',
      settings: {
    ...
    createDynamicCardGridBlueprint({
      ...
      settings: {
        ...
        ...seedBlueprintCardGridCardFields(1, {
          ...
          button2Href: '#traditional-daf-form',
          button2Style: 'blue',
          button2Tone: 'atlantean',
        }),
      },
    }),
    {
      ...
      settings: {
        ...
        subtitle: '',
        bodyHtml: '',
        body: 'Contact us to open a traditional DAF. Use this form to start the process.',
        bgTone: 'blue',
        textTone: 'white',
        spaceBeforeRem: 2.6,
        spaceAfterRem: 2.8,
    ...
    createDynamicCardGridBlueprint({
      ...
      settings: {
        ...
        ...seedBlueprintCardGridCardFields(2, {
          ...
          body: 'Term Certificates are available with fixed or variable interest rates and terms, ranging from three months to ten years. Minimum investment $500.',
          buttonLabel: 'Start investing',
          buttonHref: 'https://secure.agfinancial.org/invest',
        }),
  ...
  '/services/insurance/mission-assure': [
    ...
    }),
    {
      ...
      settings: {
        ...
        bgTone: 'white',
        textTone: 'dark',
        sectionClassName: 'mission-assure-native-intro-body',
        copyWrap: true,
        fullBleed: false,
        spaceBeforeRem: 0,
        spaceAfterRem: 0,
    ...
    createDynamicColumnsBlueprint({
      ...
      settings: {
        ...
        col1Title: 'Domestic',
        col1Body: '',
        col1BodyHtml: '<p class="mission-assure-pricing-rate">$1.25/day</p><p class="mission-assure-pricing-note">Limited medical coverage included</p>',
        col2Enabled: true,
        col2Type: 'text',
        col2Title: 'International',
        col2Body: '',
        col2BodyHtml: '<p class="mission-assure-pricing-rate">$4.95/day</p><p class="mission-assure-pricing-note">Medical coverage included</p>',
        col3Enabled: false,
        col4Enabled: false,
      },
    }),
