...
import {
  ...
  DEFAULT_DYNAMIC_GRID_CARD_GAP_REM,
  DEFAULT_DYNAMIC_GRID_CARD_PADDING_REM,
  DEFAULT_DYNAMIC_GRID_CARD_TITLE_LINE_HEIGHT,
  DEFAULT_DYNAMIC_GRID_CARD_TITLE_BODY_SPACE_REM,
...
const sections = [
  {
    ...
    fields: [
      ...
      defineEditorField({
        ...
        max: 100,
        step: 1,
        defaultValue: DEFAULT_DYNAMIC_GRID_HEADER_WIDTH_PERCENT,
      }),
      defineEditorField({
        id: 'titleClassName',
      ...
      defineEditorField({
        id: 'headerCardsSpaceRem',
        label: 'Space after subhead',
        type: 'range',
        min: 0,
        max: 4,
        step: 0.05,
        defaultValue: DEFAULT_DYNAMIC_GRID_HEADER_CARDS_SPACE_REM,
      }),
      defineEditorField({
        id: 'subheadSizeRem',
      ...
      defineEditorField({ id: 'cardShadowOpacity', label: 'Card shadow opacity', type: 'range', min: 0, max: 100, step: 1, defaultValue: DEFAULT_DYNAMIC_GRID_CARD_SHADOW_OPACITY * 100, suffix: '%' }),
      defineEditorField({ id: 'cardHoverScale', label: 'Scale cards on hover', type: 'boolean' }),
      defineEditorField({ id: 'cardPaddingRem', label: 'Card padding', type: 'number', min: 0.75, max: 3, step: 0.05, unit: 'rem', defaultValue: DEFAULT_DYNAMIC_GRID_CARD_PADDING_REM }),
      defineEditorField({ id: 'cardGapRem', label: 'Card gutter', type: 'range', min: 0, max: 4, step: 0.05, unit: 'rem', defaultValue: DEFAULT_DYNAMIC_GRID_CARD_GAP_REM }),
...
export const cardGridBlockDefinition = createBlockDefinition({
  ...
  defaults: {
    ...
    cardTitleBodySpaceRem: DEFAULT_DYNAMIC_GRID_CARD_TITLE_BODY_SPACE_REM,
