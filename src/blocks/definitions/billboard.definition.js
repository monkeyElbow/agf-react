...
const BILLBOARD_TITLE_TONE_OPTIONS = HERO_TEXT_COLOR_OPTIONS;
...
const sections = [
  {
    ...
    fields: [
      ...
      defineEditorField({
        ...
        label: 'Billboard subtitle font weight',
        type: 'number',
        min: 400,
        max: 900,
        step: 100,
      ...
      defineEditorField({ id: 'bodyGapRem', label: 'Space above body (rem)', type: 'range', min: 0, max: 4, step: 0.05, suffix: 'rem' }),
      ...
      defineEditorField({
        id: 'justify',
        label: 'Billboard title alignment',
        type: 'select',
        options: [
          { value: 'left', label: 'Left' },
          { value: 'center', label: 'Center' },
      ...
      defineEditorField({ id: 'bodyMaxWidthPx', label: 'Billboard body max width (px)', type: 'number', min: 320, max: 1200, step: 10 }),
      defineEditorField({ id: 'lineSpacing', label: 'Billboard title line spacing', type: 'number' }),
      defineEditorField({ id: 'headerGapRem', label: 'Billboard header gap (rem)', type: 'range', min: 0, max: 4, step: 0.05, suffix: 'rem' }),
