...
Topic: Public forms library and prospectus/document-library pages  
Public routes: `/forms`, `/prospectus`  
Source files: `src/data/nativePageContent.js`, `src/data/formsLibraryLinks.js`

## Forms library overview

Browse AGFinancial form links by topic.

Current public form-library topics represented in source data:
...
- Life Enrollment and Change Form (minister)
- Standard Life Beneficiary Designation/Change
...
- Fee Structure
- Outright Gift Application
- Will Planning Document

### Retirement

- 403(b) Delay of RMD
- 403(b) In-Plan Roth Conversion
- 403(b) Loan Payment Agreement
- Contributions for One or Multiple Employees
...
Reference prospectus and investment documents.

### Public document labels
...
The public prospectus route also includes an action to download the offering circular.

REVIEW NOTE: This file stages public labels and topical organization only. The linked PDF contents themselves are not yet ingested into this package and should be reviewed separately before retrieval use.
